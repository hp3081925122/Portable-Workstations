...
@EventBusSubscriber(modid = Portable_workstations.MODID, bus = EventBusSubscriber.Bus.MOD, value = Dist.CLIENT)
public final class PortableWorkstationsClient {
    ...
    @EventBusSubscriber(modid = Portable_workstations.MODID, bus = EventBusSubscriber.Bus.GAME, value = Dist.CLIENT)
