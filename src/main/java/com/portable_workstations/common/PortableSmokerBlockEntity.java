...
public class PortableSmokerBlockEntity extends SmokerBlockEntity implements PortableFurnaceAccess {
    public PortableSmokerBlockEntity(BlockPos pos, BlockState state) {
        super(pos, state);
    }
    ...
    public int getPortableBurnTime(ItemStack stack) {
        return net.minecraftforge.common.ForgeHooks.getBurnTime(stack, RecipeType.SMOKING);
    }
}
